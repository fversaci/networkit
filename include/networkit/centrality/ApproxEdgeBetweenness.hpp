// no-networkit-format
/*
 * ApproxEdgeBetweenness.hpp
 *
 *  Created on: 09.05.2022
 *      Author: cesco
 */

#ifndef NETWORKIT_CENTRALITY_APPROX_EDGE_BETWEENNESS_HPP_
#define NETWORKIT_CENTRALITY_APPROX_EDGE_BETWEENNESS_HPP_
 ...
 */
class ApproxEdgeBetweenness final: public Centrality {
...
public:
     ...
     */
    ApproxEdgeBetweenness(const Graph &G, double epsilon = 0.01, double delta = 0.1,
...
#endif // NETWORKIT_CENTRALITY_APPROX_EDGE_BETWEENNESS_HPP_
